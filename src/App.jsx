...
const App = () => {
  ...
  const tokenAddress = process.env.REACT_APP_TOKEN_ADDRESS_ERC_20;
  ...
  if (address && (network?.[0].data.chain.id !== ChainId.Goerli)) {
    return (
      <div className="unsupported-network">
        ...
        <p>
          This dapp only works on the Goerli netwok, please switch networkd in your connected wallet.
        </p>
      </div>
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1 className="pencil">Welcome to AvatarDAO</h1>
  ...
  // if user has a membership NFT show `DAO Dashboard`
  if (hasClaimedNFT) {
    return (
